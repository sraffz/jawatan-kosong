                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        {{-- <a href="https://www.creative-tim.com/product/material-dashboard-pro"
                            class="btn btn-sm  btn-light  mb-0" onclick="smoothToPricing('pricing-soft-ui')">Buy
                            Now</a> --}}
                    </li>
                </ul>
            </div>
            ...
            <div class="container my-auto">
                <div class="row">
                    <div class="col-lg-12 m-auto text-center">
                        ...
                        <a role="button" href="{{ url('/') }}" class="btn btn-outline-white mt-4">Kembali ke Halaman Utama</a>
                    </div>
                </div>
            </div>
        </div>
