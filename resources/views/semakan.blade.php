            ...
            <div class="content">
                <div class="block block-themed block-rounded">
                    ...
                    <form action="{{ route('semak') }}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="block-content col-md-6 justify-content-center">
                ...
                @if (Request::is('keputusan-semakan'))
                    @if ($keputusan ?? '')
                                ...
                                <div class="block-content">
                                    ...
                                    @if ($keputusan->keputusan == 'berjaya')
                                        <div class="text-center mb-3 mt-3 font-size-lg">
                                            <span class="text-danger"><strong>Tahniah!</strong></span> Anda dijemput
                                            untuk
                                            menghadiri
                                            temuduga. <br>
                                        ...
                                        <table class="table table-borderless mb-3">
                                            <tbody>
                                                <tr>
                                                    <th class="w-50 text-right" scope="row" class="text-right">Tempat
                                                    </th>
                                        ...
                                        <div class="text-center mt-4 mb-4 button-pdf">
                                            <form target="_blank" action="{{ url('cetak-keputusan') }}" method="post">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id" id="id" value="{{ $keputusan->id }}">
                                            
                                              <button type="submit" class="btn btn-primary rounded-pill" target="_blank">Cetak Slip</button>
                                             
                                            </form>
                                            {{-- <a class="btn btn-danger rounded-pill" target="_blank" href="{{ url('cetak-keputusan', [$keputusan->id]) }}" role="button">Cetak</a> --}}
