                                    ...
                                    @foreach ($k_stam as $kstam)
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center ">
                                                ...
                                                @elseif ($i > 0)
                                                <button type="button" class="btn btn-outline-danger id-padam btn-sm remove-input-field-2" data-bs-id="{{ $kstam->id }}" data-bs-toggle="modal" data-bs-target="#padammatapelajara"><span class="material-icons">delete</span></button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ url('padam-mp-stam') }}" method="get">
                        {{ csrf_field() }}
