                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row col-lg-12">
                            ...
                            <div class="col-xl-6 mt-4">
                                @if ($spmu->dokumen != '')
                                    <div class="col-xl-5">
                                        <a class="btn btn-info" target="_blank" href="{{ url('storage/' . $spmu->dokumen) }}"
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control select2bs4"
                                                        ...
                                                        @foreach ($mtspm as $spm)
                                                            <option value="{{ $spm->id }}"
                                                                {{ $spm->id == $kspm->matapelajaran ? 'selected' : '' }}>
                                                                {{ $spm->subjek }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                ...
                                                <td class="text-center ">
                                                    ...
                                                    @elseif ($i > 0)
                                                        <button type="button"
                                                            ...
                                                            data-bs-id="{{ $kspm->id }}" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="padammatapelajara" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('padam-mp-spmu') }}" method="get">
                    {{ csrf_field() }}
