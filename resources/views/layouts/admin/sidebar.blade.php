<aside class="sidenav navbar navbar-backdrop navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark"
    id="sidenav-main">
        ...
        <ul class="navbar-nav">
            <li class="nav-item mb-2 mt-0">
                <a data-bs-toggle="collapse" href="#ProfileNav"
                    ...
                    <span class="nav-link-text ms-2 ps-1">{{ \Illuminate\Support\Str::limit(Auth::user()->nama, 19, $end = '..') }}</span>
                ...
                <div class="collapse {{ $page == 'Profil' || $page == 'Tetapan' ? ' show' : '' }}" id="ProfileNav"
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white  {{ $page == 'Tetapan' ? ' active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $page == 'Halaman Utama' ? ' active bg-gradient-primary' : '' }}"
                    href="{{ url('admin') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $page == 'Iklan Jawatan Kosong' ? ' active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $page == 'Konfigurasi' ? ' active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $page == 'Pentadbir' ? ' active bg-gradient-primary' : '' }}"
                    href="{{ url('admin/pentadbir') }}">
                    <span class="sidenav-mini-icon"> P </span>
                    <span class="sidenav-normal  ms-2  ps-1"> Pentadbir </span>
                </a>
            </li>
