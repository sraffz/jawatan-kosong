                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="input-group input-group-static">
                                    ...
                                    <input type="number" name="tahun" class="form-control" value="{{ old('tahun')|$matrix->tahun }}" required>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="input-group input-group-static">
                                    <label>CGPA (PNGK) <span class="text-danger">*</span></label>
                                    <input type="number" name="cgpa" step=".01" class="form-control" value="{{ old('cgpa')|$matrix->cgpa }}" required>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="row">
                        ...
                        <div class="row mt-3">
                            <div class="col-xl-12">
                                <div class="input-group input-group-static">
                                    ...
                                    <input type="text" class="form-control upcase" name="nama_kolej" value="{{ old('nama_kolej')|$matrix->nama_kolej }}" required>
                                </div>
                            </div>
                            <div class="col-xl-12 mt-3">
                                <div class="input-group input-group-static">
                                    <label>Pengkhususan <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control upcase" name="bidang" value="{{ old('bidang')|$matrix->bidang }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
